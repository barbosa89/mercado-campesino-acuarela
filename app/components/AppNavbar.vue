    ...
    class="fixed top-0 left-0 right-0 z-50 border-b border-zinc-200/50 bg-white/80 backdrop-blur-md dark:border-zinc-800/50 dark:bg-zinc-950/80">
            ...
            <div class="flex h-16 items-center justify-between">
                ...
                <div class="hidden md:flex items-center gap-8">
                    <a
                        ...
                        class="text-sm font-medium text-orange-950 transition-colors hover:text-orange-800 dark:text-orange-400 dark:hover:text-orange-100">
                        {{ link.label }}
                    </a>
                    <a
                        href="https://github.com/barbosa89/mercado-campesino-acuarela"
                        target="_blank"
                        class="inline-flex items-center justify-center rounded-lg bg-yellow-950 px-5 py-2 text-sm font-semibold text-white transition-colors hover:bg-yellow-800 dark:bg-orange-100 dark:text-orange-900 dark:hover:bg-orange-200">
        ...
        <div v-if="isOpen" class="border-t border-zinc-200 bg-white dark:border-zinc-800 dark:bg-zinc-950 md:hidden">
            <div class="px-4 py-4 flex flex-col gap-3">
                ...
                <a
                    href="https://github.com/barbosa89/mercado-campesino-acuarela"
                    class="mt-2 inline-flex items-center justify-center rounded-lg bg-yellow-950 px-5 py-3 text-sm font-semibold text-white transition-colors hover:bg-yellow-800 dark:bg-orange-100 dark:text-orange-900 dark:hover:bg-orange-200"
                    @click="closeMenu">
                    <Icon name="lucide:github" class="text-xl me-2" /> Código Fuente
                </a>
            </div>
