    ...
    <section id="tour360" class="py-24 bg-yellow-50/10 dark:bg-zinc-900/40">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div class="text-center max-w-2xl mx-auto mb-12">
                <p class="text-sm font-medium uppercase tracking-widest text-orange-900 mb-3">
                    Recorrido virtual
                </p>
                <h2
                    class="font-serif text-3xl sm:text-4xl md:text-5xl font-bold text-zinc-900 text-balance">
                    Explora en 360
                </h2>
                <p class="mt-4 text-zinc-600 text-lg leading-relaxed text-pretty">
                ...
                <template #fallback>
                    <div
                        ...
                        <div class="flex flex-col items-center gap-3">
                            <div
                                class="h-10 w-10 animate-spin rounded-full border-4 border-orange-900 border-t-transparent" />
            ...
            <div class="mt-6 flex flex-wrap items-center justify-center gap-6 text-orange-700">
